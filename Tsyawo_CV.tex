...
\begin{itemize}
  \item Ph.D. Candidate, Economics, Temple University, (\textit{Expected}: May 2020)
  ...
  \end{itemize}
	...
	\item Ph.D. Student, Economics, Temple University, 2014-2018
...
\begin{itemize}
  \item Microeconometrics and Industrial Organisation
\end{itemize}
...
\begin{enumerate}
	\item \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3194286}{Recovering distributions for the estimation of treatment
		...
		cross-sections} 
  	\item \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3048658}{Bayesian Distribution Regression}, (with Weige Huang, submitted)
\end{enumerate}

\section*{Work in Progress}
\begin{enumerate}
	\item Unobserved heterogeneity in two-part models (with Brantly Callaway)
	\item Clustered parameter estimation for dimension reduction (with Abdul-Nasah Soale)
...
\section*{Software}
\begin{itemize}
  \item R packages: \texttt{\href{https://estsyawo.github.io/bayesdistreg/}{bayesdistreg}} (with Weige Huang), \texttt{\href{https://github.com/estsyawo/bayesprdopt}{bayesprdopt}}

  \item \texttt{\href{https://github.com/estsyawo/metricsC}{C}},  \texttt{ \href{https://github.com/estsyawo/metricsFortran}{Fortran}}
