...
\begin{enumerate}
	\item A Distance Covariance-based Estimator, (with Abdul-Nasah Soale) 
...
\begin{enumerate}
	...
	\item Poverty and the Incidence of Child Labour - A Spatial Perspective (with Sylvanus Gaku)
\end{enumerate}
