...
\begin{enumerate}
  \item \href{https://academic.oup.com/ectj/advance-article-abstract/doi/10.1093/ectj/utac032/6888009?redirectedFrom=fulltext}{Feasible IV Regression without Excluded Instruments} (\textit{The Econometrics Journal}, 2022)
...
\begin{enumerate}
  \item \href{https://arxiv.org/pdf/2208.13370.pdf}{A Consistent ICM-based $\chi^2$ Specification Test}, (with Feiyu Jiang)
	...
	\item \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3394012}{Clustered Covariate Regression}, (with Abdul-Nasah Soale) - \textit{Presented at MEG October 2019}
...
\begin{itemize}
  \item June 2022: Asia Meeting of the Econometric Society (AMES), Shenzhen, China
  \item June 2022: North America Summer Meeting of the Econometric Society (NAMES), Miami, USA
  \item June 2022: Africa Meeting of the Econometric Society (AFES), Addis Ababa, Ethiopia
  \item December 2021: European Winter Meeting of the Econometric Society (EWMES), Barcelona, Spain
  \item October 2021: Meeting of the Latin American and Caribbean Economic Association (LACEA) and the Latin American Meeting of the Econometric Society (LAMES), Bogotá, Colombia
	\item June 2021: The Africa Meeting of the Econometric Society (AFES), Abidjan, C\^ote d'Ivoire
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Macro\'economie II (Spring 2021,2022)
...
\textbf{Referee}: Bulletin of Economic Research, World Development 
%\newpage
%\section*{References}
%\vspace{-.15in}
%\begin{multicols}{2}
